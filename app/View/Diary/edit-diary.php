    ...
    <div class="container mx-auto px-4 py-4 lg:px-20 lg:py-28">
        <div class="grid grid-cols-12 items-center">
            <div class="col-span-12 items-center justify-center space-y-4">
                ...
                <h1 class="font-rubik font-medium text-[38px] text-center mb-4">Edit Diary</h1>
                <form method="post" action="/user/edit-diary/<?=$model['diary']->user_email?>/<?=$model['diary']->id?>" enctype="multipart/form-data">
                    <div class="flex flex-col w-9/12 mx-auto gap-2">
                        <label for="judul" class="font-semibold ">Judul</label>
                        <input type="text" name="diary_title" class="p-4" placeholder="Tuliskan judul harimu disini..." required value="<?= $model['diary']->title ?? $model['post_title']?>">
                    </div>
                    <div class="flex flex-col w-9/12 mx-auto gap-2">
                        <label for="judul" class="font-semibold ">Pesan</label>
                        <textarea name="diary_paragraph" id="" cols="30" rows="10" class="p-4" required placeholder="Tuliskan perasaan kamu hari ini..."><?=$model['diary']->paragraph ?? $model['paragraph']?></textarea>
                    </div>
                    <div class="flex flex-col w-9/12 mx-auto gap-2">
                        ...
                        <select name="diary_mood" id="diary_mood" class="bg-dark-white rounded-md py-2 px-4" required>
                            ...
                            <option value="Bahagia" class="">Bahagia</option>
